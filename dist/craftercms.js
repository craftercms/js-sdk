(function (global, factory) {
  ...
  function httpGet(baseUrl, url, params, callback) {
      ...
      axios$1(opts).then(function (response) {
  ...
  var ContentStoreService = function () {
      function ContentStoreService(baseUrl, site) {
          classCallCheck(this, ContentStoreService);

          this.baseUrl = baseUrl;
          this.site = site;
      }

      createClass(ContentStoreService, [{
          key: 'getItem',
  ...
  var NavigationService = function NavigationService(baseUrl, site) {
      classCallCheck(this, NavigationService);

      this.baseUrl = baseUrl;
      this.site = site;
  };

  var EngineClient = function EngineClient(baseUrl, site) {
      classCallCheck(this, EngineClient);
  ...
  var SearchClient = function SearchClient(baseUrl) {
      classCallCheck(this, SearchClient);
